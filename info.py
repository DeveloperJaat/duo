...
BOT_USERNAME = environ.get("BOT_USERNAME", "showtime_file_2_bot")
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002422392187') # support group id ( make sure bot is admin )
